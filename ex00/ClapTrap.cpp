...
/*   Updated: 2023/02/07 15:57:17 by ziloughm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "Parameter constroctur called" << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const &ob)
{
    std::cout << "Copy constroctur called" << std::endl;
    *this = ob;
}
...
void    ClapTrap::beRepaired(unsigned int amount)
{
    ...
    else
    {
        ...
        std::cout  << ((amount + _hit_p) > 10 ? (10 - _hit_p) : amount) << " points!" << std::endl;
        --_energy_p;
        _hit_p += amount;
        if (_hit_p > 10)
            _hit_p = 10;
